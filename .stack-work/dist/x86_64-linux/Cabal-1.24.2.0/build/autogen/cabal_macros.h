...
/* package haskell-conll-0.1.0.0 */
#define VERSION_haskell_conll "0.1.0.0"
#define MIN_VERSION_haskell_conll(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-conll-0.1.0.0-CSTI7tPyX32627TPrQeUro"

#define CURRENT_PACKAGE_KEY "haskell-conll-0.1.0.0-CSTI7tPyX32627TPrQeUro"
